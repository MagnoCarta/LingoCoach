...
class FilterViewController: UIViewController {
    ...
    let collectionView: UICollectionView = {
        ...
        collectionView.register(GroupFilterCollectionViewCell.self, forCellWithReuseIdentifier: "AgruparFiltro")
    ...
    @objc func clearFilter() {
        let itens = collectionView.visibleCells as! [GroupFilterCollectionViewCell]
        for item in itens {
            item.active = false
        }
...
extension FilterViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let cell = collectionView.cellForItem(at: indexPath) as! GroupFilterCollectionViewCell
        if indexPath.section == 0 {
            if !cell.active {
